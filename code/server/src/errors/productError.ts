...
const DATE_INCOMPATIBLE_PRODUCT_ARRIVAL = "Provided date is incompatible with product arrival date"
...
class DateIncompatibleWithProductArrivalError extends Error {
    customMessage: string
    customCode: number

    constructor() {
        super()
        this.customMessage = DATE_INCOMPATIBLE_PRODUCT_ARRIVAL
        this.customCode = 400
    }
}

export { ProductNotFoundError, ProductAlreadyExistsError, ProductSoldError, EmptyProductStockError, LowProductStockError, DateIncompatibleWithProductArrivalError }
