...
class UserDAO {
    ...
    /**
     * Returns a users list object from the database.
     * @returns A Promise that resolves the information of all the users from the database
     */
        ...
        return new Promise<User[]>((resolve, reject) => {
            try {
                ...
                db.all(sql, (err: Error | null, rows: any) => {
                    ...
                    const userList: User[] = rows.map((user: User)=>new User(user.username, user.name, user.surname, user.role, user.address, user.birthdate))
    ...
    /**
     * Returns a users list object from the database based on the role.
     * @param role The Role of the user to retrieve
     * @returns A Promise that resolves the information of the requested users with the specified role
     */
     ...
     * @returns A Promise that resolves to true if all non-Admin users has been deleted
     */
